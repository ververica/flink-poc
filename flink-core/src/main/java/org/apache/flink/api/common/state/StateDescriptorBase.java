 ...
 */
@PublicEvolving
public abstract class StateDescriptorBase<T> implements Serializable {
    private static final Logger LOG = LoggerFactory.getLogger(StateDescriptorBase.class);
     ...
     *     a value before.
     */
    protected StateDescriptorBase(String name, TypeSerializer<T> serializer, @Nullable T defaultValue) {
     ...
     *     a value before.
     */
    protected StateDescriptorBase(String name, TypeInformation<T> typeInfo, @Nullable T defaultValue) {
        this.name = checkNotNull(name, "name must not be null");
     ...
     * consider using the {@link #StateDescriptorBase(String, TypeInformation, Object)} constructor.
     *
     * @param name The name of the {@code StateDescriptor}.
     ...
     *     a value before.
     */
    protected StateDescriptorBase(String name, Class<T> type, @Nullable T defaultValue) {
        this.name = checkNotNull(name, "name must not be null");
     ...
     *
     * <p>If enabling the TTL configuration, the field {@link StateDescriptorBase#defaultValue} will be
     * invalid.
     *
    ...
    public boolean equals(Object o) {
        if (o == this) {
            ...
            final StateDescriptorBase<?> that = (StateDescriptorBase<?>) o;
