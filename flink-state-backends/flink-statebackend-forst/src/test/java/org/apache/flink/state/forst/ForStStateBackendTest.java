...
import static org.apache.flink.state.forst.ForStOptions.*;
import static org.junit.Assert.assertEquals;
import static org.junit.Assert.assertNull;

public class ForStStateBackendTest {
    ...
    protected ConfigurableStateBackend getStateBackend() throws IOException {
        ...
        configuration.set(FOR_ST_MODE, ForStMode.LOCAL);
        configuration.set(FOR_ST_WORKING_DIR, "/tmp/");
