...
import org.apache.flink.state.forst.async.AsyncForStValueState;
...
public class ForStKeyedStateBackend<R, K> extends RocksDBKeyedStateBackend<K> {
    ...
    private static final Map<StateDescriptor.Type, StateCreateFactory> STATE_CREATE_FACTORIES =
            Stream.of(
                            Tuple2.of(
                                    ...
                                    (StateCreateFactory) AsyncForStValueState::create))
