...
public class ForStStateUploader extends RocksDBStateDataTransfer {

    private static final Logger LOG = LoggerFactory.getLogger(ForStStateUploader.class);

    private final Path remoteDBBasePath;

    public ForStStateUploader(Path remoteDBBasePath, int numberOfSnapshottingThreads) {
