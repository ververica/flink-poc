...
CUR_DIR=`pwd`
JAR_NAME="flink-examples-streaming-1.19-SNAPSHOT-AsyncWordCount.jar"
JAR_PATH="${CUR_DIR}/${JAR_NAME}"
CLASS_NAME="org.apache.flink.streaming.examples.wordcountasync.WordCount"
jobName=$1
...
envsubst < ./test-flink-conf.yaml > ./conf/flink-conf.yaml
