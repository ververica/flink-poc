 ...
 */
@Internal
public class BundleSimpleUdfOperatorFactory<IN, OUT> extends BundleSimpleOperatorFactory<IN, OUT>
        implements UdfStreamOperatorFactory<OUT> {

    /** Create a SimpleOperatorFactory from existed StreamOperator. */
    @SuppressWarnings("unchecked")
    public static <IN, OUT> BundleSimpleUdfOperatorFactory<IN, OUT> of(
    ...
    protected BundleSimpleUdfOperatorFactory(OneInputStreamOperator<IN, OUT> operator) {
        super(operator);
    }
